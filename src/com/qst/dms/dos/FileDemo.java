...
public class FileDemo {
	public static void main(String[] args) {
		...
		/*matchLogs.add(new MatchedLogRec(
				new LogRec(new Date(), "青島",DataBase.GATHER, "zhangsan", "192.168.1.1", 1),
				new LogRec(new Date(), "青島", DataBase.GATHER, "zhangsan",	"192.168.1.1", 0)));
		matchLogs.add(new MatchedLogRec(
				new LogRec(new Date(), "北京",DataBase.GATHER, "lisi", "192.168.1.6", 1), 
				new LogRec(new Date(), "北京", DataBase.GATHER, "lisi", "192.168.1.6", 0)));
		matchLogs.add(new MatchedLogRec(
				new LogRec(new Date(), "济南",DataBase.GATHER, "wangwu", "192.168.1.89", 1),
				new LogRec(new Date(), "济南", DataBase.GATHER,	"wangwu", "192.168.1.89", 0)));*/
		//保存匹配的日志信息到文件中，可追加
		...
		/*matchTrans.add(new MatchedTransport(
				new Transport(new Date(), "青島",DataBase.GATHER,"zhangsan","zhaokel",1),
				new Transport(new Date(), "北京",DataBase.GATHER,"lisi","zhaokel",2),
				new Transport(new Date(), "北京",DataBase.GATHER,"wangwu","zhaokel",3)));	
		matchTrans.add(new MatchedTransport(
				new Transport(new Date(), "青島",DataBase.GATHER,"maliu","zhaokel",1),
				new Transport(new Date(), "北京",DataBase.GATHER,"sunqi","zhaokel",2),
				new Transport(new Date(), "北京",DataBase.GATHER,"fengba","zhaokel",3)));*/
		//保存匹配的物流信息到文件中，可追加
