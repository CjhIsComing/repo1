...
public class DBDemo {
	public static void main(String[] args) {
		...
		matchTrans.add(new MatchedTransport(
				new Transport(new Date(), "青島",DataBase.GATHER,"maliu","w",1),
				new Transport(new Date(), "北京",DataBase.GATHER,"sunqi","w",2),
				new Transport(new Date(), "北京",DataBase.GATHER,"fengba","w",3)));*/
		//保存匹配的物流信息到数据库中
