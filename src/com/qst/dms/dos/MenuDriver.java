		...
		try {
			while (true) {
				...
				case 4: {
					...
					// 日志数据显示
					//1.从文件中显示
					/*System.out.println("显示从文件中读取的已匹配的日志数据：");
					...
					System.out.println("\n");
					// 物流数据显示
					/*System.out.println("显示从文件中读取的已匹配的物流数据：");
					ArrayList<MatchedTransport> matchTransport = new ArrayList<>();
					matchTransport = tranService.readMatchedTransport();
					tranService.showMatchTransport(matchTransport);
					matchTransport.clear();*/
					/*System.out.println("显示从数据库中读取的已匹配的物流数据：");
