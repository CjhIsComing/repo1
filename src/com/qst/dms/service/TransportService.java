	...
	public Transport inputTransport() {
		...
		try {
			...
			trans = new Transport(id, nowDate, address, type, handler, reciver,
					transportType);
			/*trans = new Transport(nowDate, address, type, handler, reciver,
					transportType);*/
		} catch (Exception e) {
